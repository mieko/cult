...
requires the Linode API gem, the DigitalOcean driver requires DropletKit, etc.  
Cult will ask, and then install these required gems, only when you go to use
the driver.
...
#### Special Roles
There are two Roles generated by default that the project generator that you
should think of as special:
